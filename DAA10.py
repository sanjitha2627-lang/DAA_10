...
# Changed N from 5000 to 3000
N = 3000

test_cases = {
    'Random': [random.randint(10, 50000) for _ in range(N)],
    'Sorted': list(range(100, 100 + N)),
    'Reverse': list(range(3000, 0, -1)),
    'Nearly Sorted': list(range(200, 200 + N))
}
